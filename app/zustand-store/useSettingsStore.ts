...
export const useSettingsStore = create<SettingsStore>()(
  persist(
    (set) => ({
      ...
      toggleMute: () =>
        set((state) => {
          const newMuted = !state.muted; // NOTE: Music control should ideally check GameStore for game status,
    ...
    {
      name: "ai-settings-storage", // Only persist the settings themselves
